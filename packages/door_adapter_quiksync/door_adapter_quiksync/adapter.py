"""QuikSync door adapter entry point — v1 stub.
...
special-case "fleet only" — the door adapter container starts, logs a
...
log = logging.getLogger("door_adapter_quiksync")


def main(argv: list[str] | None = None) -> int:
    log.info(
        "door_adapter_quiksync: v1 stub — door adapter ships in v2. "
